...
class Datasets(Dataset):
    def __init__(self, root_dir="./data3", transforms=None):
        super(Datasets, self).__init__()

        self.down_ratio = 1
        self.img_w = 128 // self.down_ratio
        self.img_h = 128 // self.down_ratio

        self.img_path = os.path.join(root_dir, "images")
        self.lab_path = os.path.join(root_dir, "labels")
        self.img_list = glob.glob(os.path.join(self.img_path, "*.png"))
